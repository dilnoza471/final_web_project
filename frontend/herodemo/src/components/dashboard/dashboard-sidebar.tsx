...
import { LayoutDashboard, BookOpen, GraduationCap, Calendar, Clock, Settings, HelpCircle, LogOut } from "lucide-react"
    ...
    >
      <div className="h-full px-3 py-4 overflow-y-auto">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
              <GraduationCap className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" />
          ...
          <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
              <Clock className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" />
